...
<div class="row">
    ...
    <div class="col-md-4">
        <a href="<?=Config::get('siteUrl');?>/tasks/index/name/<?=$data['current_page']?>" class="btn btn-<?=($data['params'][0] == 'name' ? 'success' : 'secondary') ?> btn-block btn-sm">По имени</a>
    </div>
    <div class="col-md-4">
        <a href="<?=Config::get('siteUrl');?>/tasks/index/email/<?=$data['current_page']?>" class="btn btn-<?=($data['params'][0] == 'email' ? 'success' : 'secondary') ?> btn-block btn-sm">По E-mail</a>
    </div>
    <div class="col-md-4">
        <a href="<?=Config::get('siteUrl');?>/tasks/index/status/<?=$data['current_page']?>" class="btn btn-<?=($data['params'][0] == 'status' ? 'success' : 'secondary') ?> btn-block btn-sm">По статусу</a>
    </div>
</div>
