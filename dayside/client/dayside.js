    ...
    return teacss.ui.panel.extend({
        init: function (options) {
            ...
            this.dropDiv = $("<div>").addClass("ui-drop-icons").hide().append(
                $("<div>").html("â—„").data("tabPanel",this.leftPanel),
                $("<div>").html("â–¼").data("tabPanel",this.bottomPanel),
                $("<div>").html("â–º").data("tabPanel",this.rightPanel)
            )
